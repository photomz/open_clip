...
import torch
from src.open_clip.src.open_clip.hf_model import _POOLERS, HFTextEncoder
...
def test_poolers():
    bs, sl, d = 2, 10, 5
    h = torch.arange(sl).repeat(bs).reshape(bs, sl)[..., None] * torch.linspace(
        0.2, 1.0, d
    )
...
@pytest.mark.parametrize(
    "model_id",
    ["arampacha/roberta-tiny", "roberta-base", "xlm-roberta-base", "google/mt5-base"],
)
